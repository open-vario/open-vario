...
#ifndef OPENVARIO100BOARD_H
#define OPENVARIO100BOARD_H
...
/** \brief Interface for all boards implementations */
class OpenVario10Board : public IBoard
{
    public:
