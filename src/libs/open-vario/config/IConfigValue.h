...
CONFIGVALUE_ARRAY_TYPE(bool)
CONFIGVALUE_ARRAY_TYPE(char)
CONFIGVALUE_ARRAY_TYPE(uint8_t)
CONFIGVALUE_ARRAY_TYPE(int8_t)
CONFIGVALUE_ARRAY_TYPE(uint16_t)
CONFIGVALUE_ARRAY_TYPE(int16_t)
CONFIGVALUE_ARRAY_TYPE(uint32_t)
CONFIGVALUE_ARRAY_TYPE(int32_t)
CONFIGVALUE_ARRAY_TYPE(float)
CONFIGVALUE_ARRAY_TYPE(double)
