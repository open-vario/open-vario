...
#ifndef LINUXOPENVARIOAPP_H
#define LINUXOPENVARIOAPP_H
...
class LinuxOpenVarioApp : public OpenVarioApp, public ILogListener
{
    public:
    ...
    private:
        ...
        /** \brief Singleton */
        static LinuxOpenVarioApp m_singleton;
};

}

#endif // LINUXOPENVARIOAPP_H
