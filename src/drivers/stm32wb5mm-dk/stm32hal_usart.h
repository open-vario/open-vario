...
#ifndef OV_STM32HAL_USART_H
#define OV_STM32HAL_USART_H
...
/** @brief Serial port driver implementation using STM32HAL and USART peripheral */
class stm32hal_usart : public i_serial
{
  public:
    /** @brief Constructor */
    stm32hal_usart();
  ...
  private:
    ...
    static constexpr uint32_t RX_BUFFER_SIZE = 64u;
